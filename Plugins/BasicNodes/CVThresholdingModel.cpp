...
const QString CVThresholdingModel::_category = QString( "Image Conversion" );

const QString CVThresholdingModel::_model_name = QString( "CV Thresholding" );
...
save() const
{
    ...
    QJsonObject cParams;
    cParams["threshold_type"] = mParams.miThresholdType;
    cParams["threshold_value"] = mParams.mdThresholdValue;
    cParams["binary_value"] = mParams.mdBinaryValue;
...
load(QJsonObject const& p)
{
    ...
    {
        QJsonValue v = paramsObj[ "threshold_type" ];
        if( !v.isNull() )
        {
