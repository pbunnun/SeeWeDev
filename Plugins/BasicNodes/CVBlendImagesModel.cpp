...
const QString CVBlendImagesModel::_category = QString( "Image Operation" );

const QString CVBlendImagesModel::_model_name = QString( "CV Blend Images" );
...
void CVBlendImagesModel::em_radioButton_clicked()
{
    if(allports_are_active(mapCVImageInData))
    {
        processData(mapCVImageInData,mpCVImageData,mParams);
...
bool CVBlendImagesModel::allports_are_active(const std::shared_ptr<CVImageData> (&ap)[2]) const
{
