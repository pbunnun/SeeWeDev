...
const QString CVFindContourModel::_category = QString( "Image Processing" );

const QString CVFindContourModel::_model_name = QString( "CV Find Contour" );
...
void CVFindContourModel::processData(const std::shared_ptr<CVImageData> &in, std::shared_ptr<ContourPointsData> &outContour, const ContourParameters &params)
{
