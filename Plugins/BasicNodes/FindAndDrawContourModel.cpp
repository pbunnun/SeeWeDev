...
void FindAndDrawContourModel::processData(const std::shared_ptr<CVImageData> &in, std::shared_ptr<CVImageData> &outImage,
...
float FindAndDrawContourModel::get_stddev(const std::vector<float> &vec, float mean)
{
...
const QString FindAndDrawContourModel::_category = QString( "Image Processing" );

const QString FindAndDrawContourModel::_model_name = QString( "Find and Draw Contour" );
