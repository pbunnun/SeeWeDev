...
const QString CVDrawContourModel::_category = QString( "Image Processing" );

const QString CVDrawContourModel::_model_name = QString( "CV Draw Contour" );
...
void CVDrawContourModel::processData(const std::shared_ptr<CVImageData> &in, std::shared_ptr<CVImageData> &outImage,
