...
const QString CVPixelIterationModel::_category = QString( "Image Modification" );

const QString CVPixelIterationModel::_model_name = QString( "CV Pixel Iteration" );

const std::string CVPixelIterationModel::color[3] = {"B", "G", "R"};
