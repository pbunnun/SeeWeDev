...
const QString DoubleSpinButtonModel::_category = "GUI";
const QString DoubleSpinButtonModel::_model_name = "Double Spin Button";

DoubleSpinButtonModel::DoubleSpinButtonModel()
    : PBNodeDelegateModel(_model_name, true),
      mpEmbeddedWidget(new QDoubleSpinBox(qobject_cast<QWidget*>(this))),
      mpDoubleData(std::make_shared<DoubleData>(mdValue))
{
    ...
    connect(mpEmbeddedWidget, QOverload<double>::of(&QDoubleSpinBox::valueChanged), this, &DoubleSpinButtonModel::em_value_changed);
...
unsigned int DoubleSpinButtonModel::nPorts(PortType portType) const
{
    switch (portType) {
    case PortType::In:
        return 0;
...
NodeDataType DoubleSpinButtonModel::dataType(PortType portType, PortIndex portIndex) const
{
...
QString DoubleSpinButtonModel::portToolTip(QtNodes::PortType portType, QtNodes::PortIndex portIndex) const
{
    if (portType == QtNodes::PortType::Out && portIndex == 0) {
        return "Double Output: The current double-precision floating-point value of the spin box.";
    }
    return PBNodeDelegateModel::portToolTip(portType, portIndex);
}

std::shared_ptr<NodeData> DoubleSpinButtonModel::outData(PortIndex portIndex)
{
...
void DoubleSpinButtonModel::setInData(std::shared_ptr<NodeData>, PortIndex)
{
    // No input ports
}

QJsonObject DoubleSpinButtonModel::save() const
{
...
void DoubleSpinButtonModel::load(const QJsonObject &p)
{
...
void DoubleSpinButtonModel::setModelProperty(QString &id, const QVariant &value)
{
...
void DoubleSpinButtonModel::enable_changed(bool enable)
{
    PBNodeDelegateModel::enable_changed(enable);
    mpEmbeddedWidget->setEnabled(enable);
}

void DoubleSpinButtonModel::em_value_changed(double val)
{
