...
class DoubleSpinButtonModel : public PBNodeDelegateModel
{
    Q_OBJECT
public:
    DoubleSpinButtonModel();
    virtual ~DoubleSpinButtonModel() override { }
...
private:
    ...
    std::shared_ptr<DoubleData> mpDoubleData;
    QPixmap _minPixmap;
